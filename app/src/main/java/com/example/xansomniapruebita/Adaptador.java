...
public class Adaptador extends BaseAdapter {
    ...
    public View getView(int posicion, View view, ViewGroup viewGroup) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(a, R.array.ubicaciones, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

        TextView txtStoreLocation = v.findViewById(R.id.txt_store_location);
        String location = guitar.getStoreLocation();
        ...
        editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Spinner storeLocation = dialog.findViewById(R.id.sp_guitarstoreloca);
                ...
                guitarType.setText(guitar.getGuitarType());
                guitarPrice.setText(guitar.getGuitarPrice());
                storeLocation.setSelection(adapter.getPosition(guitar.getStoreLocation()));
                    ...
                    public void onClick(View view) {
                        try {
                            guitar = new Guitar(getId(), guitarModel.getText().toString(),
                                    ...
                                    storeLocation.getSelectedItem().toString());
                            dao.editar(guitar);
                            lista = dao.verTodo();
