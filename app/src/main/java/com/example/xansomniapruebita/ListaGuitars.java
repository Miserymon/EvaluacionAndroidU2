    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addGuitar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Spinner storeLocationSpinner = dialog.findViewById(R.id.sp_guitarstoreloca);
                ArrayAdapter<CharSequence> spinnerAdapter = ArrayAdapter.createFromResource(
                        ListaGuitars.this, R.array.ubicaciones, android.R.layout.simple_spinner_item);
                spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                storeLocationSpinner.setAdapter(spinnerAdapter);
                ...
                guardar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        try {
                            String selectedLocation = storeLocationSpinner.getSelectedItem().toString();
